"""
Bias supply backend using the e4control library (local TCT_Setup/e4control).
...
# makes TCT_app self-contained); the second is the original sibling checkout in
# the TCT_Setup tree, kept as a back-compat fallback.
_E4C_ROOTS = [
    Path(__file__).parent.parent / "vendor",                       # TCT_app/vendor
    Path(__file__).parent.parent.parent / "e4control" / "E4control",  # TCT_Setup/e4control/E4control
]
...
class E4ControlBiasSupply(BiasSupplyBase):
    ...
    The e4control library is NOT pip-installed; it lives at
    TCT_Setup/e4control/E4control and is imported from there at connect time.
    """
