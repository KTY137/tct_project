...
| MINOR | QtDangerGate: a timed-out confirm can leave a stray queued `_confirm_requested` emit (cosmetic; fail-closed already occurred). Clear it on timeout. | `TCT_app/gui/qt_danger_gate.py` | Noah | 2026-07-07 |
